...
function initFormPopup(){
    ...
    $(document).mouseup(function (e) {
        ...
        if (container.has(e.target).length === 0 && e.target.className !== 'popup-form enable'){
            ...
            $('.order-form-wrapper').removeClass('enable');
...
function initFormValidation() {
	...
	$('#submit,#submit2').click(function () {
        ...
        var name = $('input[name=orderName]');
		var email = $('input[name=orderEmail]');
		var tel = $('input[name=orderPhone]');
        var comment = $('textarea[name=orderMessage]');
