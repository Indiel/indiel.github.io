...
function initSlider() {
    ...
    slider.each(function() {
		...
		var count = jQuery(".result").find(".count");
...
;(function($) {
	...
	jcf.addModule({
		name: 'Radio',
		selector: 'input[type="radio"]:not(.jcf-off)',
		options: {
			wrapNative: true,
...
function calculateIncome() {
	var investmentTabs = $('#investment-tabs');
	var selectedAmount = investmentTabs.children('input[name="investment-tabs"]:checked').value;

	console.log(investmentTabs);
